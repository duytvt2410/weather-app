$(document).ready(function(){
		...
		function getCurrenWeather(yourCity) {
			var url = "http://api.openweathermap.org/data/2.5/weather?q="+yourCity+"&lang=vi&appid=04e7cab8aad69342c877a74f5efaef68&units=metric";
			$.ajax({
			    url: url,
			    type: "get",
			    dataType: "json",
		...
		function getNextWeather(yourCity) {
			var url = "http://api.openweathermap.org/data/2.5/forecast?q="+yourCity+"&lang=vi&appid=04e7cab8aad69342c877a74f5efaef68&units=metric";
			$.ajax({
			    url: url,
			    type: "get",
			    dataType: "json",
